...
const WELCOME_MESSAGE: Message = {
  role: "assistant",
  content:
    "Hello! I'm **CAGD**, the official virtual assistant of the Controller & Accountant-General's Department. How can I help you today?",
};

const SUGGESTIONS = [
  "What are CAGD's core functions?",
      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-20 right-6 z-[45] h-14 w-14 rounded-full bg-gradient-to-br from-primary to-primary/80 text-white shadow-xl flex items-center justify-center hover:shadow-2xl transition-shadow"
        ...
        >
          ...
          <div className="px-4 py-3 border-t border-border bg-background shrink-0">
            ...
            <p className="text-[10px] text-muted-foreground/60 text-center mt-2">
              Powered by CAGD — Responses are AI-generated
            </p>
          </div>
        </SheetContent>
      </Sheet>
