...
const eServices = [
  { label: "e-Pay Services", url: "https://gogepayservices.com", desc: "View your payslip online" },
  { label: "EPV", url: "https://www.gogepv.com", desc: "Electronic payment voucher" },
  { label: "TPRS", url: "https://gogtprs.com", desc: "Third party reporting system" },
];
...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="relative overflow-hidden" role="contentinfo" aria-label="Site footer">
      ...
      {/* ── Top separator ── */}
      <div className="relative h-1 bg-gradient-to-r from-transparent via-secondary/60 to-transparent" />
        ...
        <div className="container py-14 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              <Link to="/" className="inline-flex items-center gap-3 mb-5 group">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/50 uppercase tracking-wider">Est. 1885</p>
                </div>
              </Link>
              <p className="text-sm leading-relaxed text-white/60 mb-6">
                Controller & Accountant-General's Department — providing Public Financial Management Services to the Government and general public of Ghana.
              </p>

              {/* Newsletter */}
              <div className="bg-white/[0.06] rounded-xl p-4 border border-white/[0.08]">
                <h5 className="font-heading font-semibold text-sm text-white mb-2">Newsletter</h5>
                <p className="text-xs text-white/45 mb-3">Get the latest news and updates from CAGD.</p>
            ...
            <div className="lg:col-span-2 lg:col-start-6">
              <h4 className="font-heading font-semibold text-sm text-white uppercase tracking-wider mb-5">About</h4>
            ...
            <div className="lg:col-span-2">
              <h4 className="font-heading font-semibold text-sm text-white uppercase tracking-wider mb-5">Resources</h4>
              <ul className="space-y-2.5">
            ...
            <div className="lg:col-span-3">
              <h4 className="font-heading font-semibold text-sm text-white uppercase tracking-wider mb-5">Contact</h4>
        ...
        <div className="border-t border-white/[0.06]">
          <div className="container py-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <span className="text-xs font-heading font-semibold text-white/40 uppercase tracking-wider shrink-0">e-Services</span>
              ...
              <p className="text-xs text-white/35 sm:ml-auto shrink-0">
                &copy; {new Date().getFullYear()} CAGD. All Rights Reserved.
              </p>
            </div>
          </div>
        </div>
