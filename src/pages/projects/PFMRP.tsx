          ...
          >
            <div className="px-4 md:px-5 pb-5 space-y-4 border-t border-border pt-4">
              ...
              {sub.activities.length > 0 && (
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-primary">Key Activities</span>
    ...
    <>
          ...
          <motion.div style={{ opacity: heroOpacity }} className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
            <div className="flex-1">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                <Badge className="bg-secondary/20 text-secondary border-secondary/30 mb-4">Strategic Reform Initiative</Badge>
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold mb-4 leading-tight">
                  Public Financial<br />Management Reform
                </h1>
                <p className="text-white/70 max-w-xl text-lg">
                  A comprehensive initiative to modernize Ghana's public financial management systems through strengthened systems and procedures and targeted capacity building.
                </p>
              </motion.div>
            </div>
            <motion.div
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-xs text-white/60 uppercase tracking-wider">Progress</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <motion.div
              ...
              className="flex-1"
            >
              <h2 className="text-3xl font-heading font-bold text-foreground mb-6">About This Project</h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  The Public Financial Management Reform Project (PFMRP) seeks to achieve improvement in budget management, financial control and reporting of the <strong className="text-foreground">Government of Ghana</strong> with the aim of enhancing fiscal discipline, strategic allocation of resources and service delivery efficiency, <strong className="text-foreground">through strengthened systems and procedures</strong> and targeted capacity building.
                </p>
                <p>
                  The Project has 4 components which are further divided into eight institutional sub-components covering the key PFM systems. Led by the Controller & Accountant-General's Department (CAGD), the reform has connected over 700 Ministries, Departments, and Agencies (MDAs) to centralized financial management systems.
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-4 lg:w-[360px] shrink-0">
              {[
                { label: "Components", value: 4, icon: BarChart3, color: "bg-emerald-500/10 text-emerald-600" },
                { label: "Sub-Components", value: 16, icon: Database, color: "bg-blue-500/10 text-blue-600" },
                { label: "MDAs Connected", value: 703, icon: Shield, color: "bg-violet-500/10 text-violet-600" },
                { label: "Staff Trained", value: 5000, suffix: "+", icon: Users, color: "bg-amber-500/10 text-amber-600" },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
      ...
      <section className="py-16 bg-muted/50">
        <div className="container max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-2 text-center">The Public Financial Management Reform Project</h2>
            <p className="text-muted-foreground text-center mb-8 max-w-2xl mx-auto">
              Eight institutional sub-components covering the key PFM systems and their implementing MDAs.
            </p>
            <div className="rounded-2xl border border-border overflow-hidden bg-card shadow-sm">
              <div className="grid grid-cols-2 bg-primary text-white">
                <div className="px-5 py-3 font-bold text-sm uppercase tracking-wider">Sub-Component / PFM System</div>
                <div className="px-5 py-3 font-bold text-sm uppercase tracking-wider">Implementing MDA</div>
              </div>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Project Components</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Four strategic components with 16 sub-components driving comprehensive reform across Ghana's public financial management landscape. Click each sub-component to view objectives and activities.
            </p>
          </motion.div>
        ...
        <div className="container relative z-10 text-white text-center">
          ...
          >
            <blockquote className="text-2xl md:text-4xl font-heading font-bold italic leading-snug max-w-3xl mx-auto">
              "Enhancing budget credibility through transparent, accountable, and efficient public financial management."
            </blockquote>
            <p className="text-white/60 mt-4 text-sm uppercase tracking-widest">PFMRP Vision Statement</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          ...
          >
            <h2 className="text-3xl font-heading font-bold text-foreground mb-4">Related Documents</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">Key manuals, accounting frameworks, and Chart of Accounts editions supporting the PFMRP reform.</p>
          </motion.div>
