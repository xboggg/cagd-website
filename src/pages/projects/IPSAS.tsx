    ...
    <>
      ...
      <section className="relative min-h-[480px] md:min-h-[540px] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <Badge className="bg-secondary/20 text-secondary border-secondary/30 mb-4">Accounting Standards</Badge>
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold mb-4 leading-tight">
                IPSAS<br /><span className="text-secondary">Implementation</span>
              </h1>
              <p className="text-white/60 max-w-lg text-lg mb-8">
                Ghana's transition to International Public Sector Accounting Standards — improving transparency, comparability, and accountability in government financial reporting.
              </p>
              <div className="flex gap-6">
                <div className="bg-white/10 backdrop-blur rounded-xl px-6 py-4">
                  ...
                  <div className="text-xs text-white/50 mt-1">Standards Adopted</div>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl px-6 py-4">
                  <div className="text-3xl font-heading font-bold text-secondary">
                    <Counter value={percent} suffix="%" />
                  </div>
                  <div className="text-xs text-white/50 mt-1">Compliance Rate</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                ...
                <span className="text-xs text-white/50 uppercase tracking-widest mt-1">Adopted</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-heading font-bold text-foreground mb-8 text-center">What is IPSAS?</h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">The IPSAS Board</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { value: 42, label: "Standards Issued", icon: BookOpen },
              { value: 100, suffix: "+", label: "Countries Adopted", icon: Globe },
              { value: 15, suffix: "+", label: "African Countries", icon: Landmark },
              { value: 5, suffix: "+", label: "Int'l Bodies (UN, AU)", icon: Building2 },
            ].map((stat, i) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 bg-background">
        <div className="container">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Benefits of IPSAS</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">Key advantages of adopting International Public Sector Accounting Standards.</p>
          </motion.div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container relative z-10 text-white">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">IPSAS in Ghana</h2>
      ...
      <section className="py-20 bg-background">
        <div className="container max-w-4xl">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">The Journey So Far</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Key milestones in coordinating IPSAS implementation across all covered entities.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-10"
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Standards Tracker</h2>
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">Track Ghana's progress across all 36 IPSAS standards. Click any card to learn more.</p>
            ...
            <div className="inline-flex rounded-xl bg-card border border-border p-1 gap-1">
              {(["all", "adopted", "pending"] as const).map((f) => (
                ...
                >
                  ...
                  {f} {f === "all" ? `(${total})` : f === "adopted" ? `(${adopted})` : `(${total - adopted})`}
                </Button>
              ))}
            </div>
          </motion.div>
                  ...
                  <div className={`relative min-h-[130px] rounded-xl border-2 transition-all duration-300 ${
                    ...
                    {flipped === s.id ? (
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground/60 mt-3">Click to flip back</p>
                      </motion.div>
                    ) : (
      ...
      <section className="py-20 bg-background">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-heading font-bold text-foreground mb-4">Adoption Journey</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">Ghana's progressive adoption of IPSAS standards over the past decade.</p>
          </motion.div>
            ...
            <div className="flex items-center min-w-[700px] px-4">
              ...
              {adoptionTimeline.map((t, i) => (
                ...
                >
                  ...
                  <span className="text-lg font-heading font-bold text-foreground">{t.year}</span>
                  <p className="text-xs text-muted-foreground mt-1 max-w-[120px] leading-tight">{t.event}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-heading font-bold text-foreground mb-4">IPSAS Resources & Downloads</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">Templates, policies, guidelines, and Chart of Accounts editions supporting IPSAS implementation.</p>
          </motion.div>
