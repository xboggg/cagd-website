...
const projects = [
  {
    slug: "pfmrp",
    title: "Public Financial Management Reform Project",
    acronym: "PFMRP",
    description: "A comprehensive reform initiative to modernize Ghana's public financial management systems, improve fiscal transparency, and strengthen accountability across all government institutions.",
    ...
    stats: [
      { label: "Components", value: 4, icon: BarChart3 },
      { label: "Regions", value: 16, icon: Shield },
      { label: "MDAs Connected", value: 703, icon: Users },
      { label: "Staff Trained", value: 5000, suffix: "+", icon: TrendingUp },
    ],
  },
  {
    slug: "ipsas",
    title: "International Public Sector Accounting Standards",
    acronym: "IPSAS",
    description: "Ghana's transition to International Public Sector Accounting Standards — improving transparency, comparability, and accountability in government financial reporting across all public sector entities.",
    image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&q=80",
    fallbackImage: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&q=80",
    status: "Ongoing",
    color: "from-blue-600 to-indigo-700",
    stats: [
      { label: "Standards Adopted", value: 31, icon: CheckCircle },
      { label: "Total Standards", value: 36, icon: BookOpen },
      { label: "Compliance", value: 86, suffix: "%", icon: TrendingUp },
      { label: "Years Active", value: 10, suffix: "+", icon: Shield },
    ],
  },
];
      ...
      <section ref={heroRef} className="relative h-[420px] md:h-[500px] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 text-white">
          <motion.div style={{ opacity: heroOpacity }}>
            ...
            >
              <Badge className="bg-secondary/20 text-secondary border-secondary/30 mb-4">Strategic Initiatives</Badge>
              ...
              <p className="text-white/70 max-w-2xl text-lg md:text-xl leading-relaxed">
                Driving reform and innovation in Ghana's public financial management through strategic projects that strengthen accountability and transparency.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container relative z-10 text-center text-white">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
              Transforming Public Finance in Ghana
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto mb-8 text-lg">
              These strategic projects represent CAGD's commitment to building a modern, transparent, and accountable public financial management system for Ghana.
            </p>
            <Link
              to="/reports"
