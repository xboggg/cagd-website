      ...
      >
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              Our team consists of seasoned experts dedicated to serving the citizens of Ghana.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              { num: 16, label: "Regions Covered", suffix: "" },
              { num: 703, label: "MDAs Served", suffix: "+" },
              { num: 5000, label: "Staff Nationwide", suffix: "+" },
            ].map((stat, i) => (
            ...
            {dcags.length > 0 && (
              <>
                ...
                >
                  ...
                  <p className="text-sm font-heading font-semibold text-muted-foreground uppercase tracking-widest">Deputy Controllers</p>
                  <div className="h-px flex-1 bg-border" />
                </motion.div>
