...
function getProfileTypeLabel(type: string) {
  switch (type) {
    case "CAG": return "Controller & Accountant-General";
    case "DCAG": return "Deputy Controller & Accountant-General";
    case "Regional": return "Regional Director";
    default: return type;
  }
}
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="flex items-center gap-3 text-white/40 text-sm justify-center lg:justify-start">
                ...
                <span>Controller & Accountant-General's Department</span>
              </div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-heading font-bold text-foreground">Biography</h2>
              </div>
              ...
              {bioParagraphs.length > 0 ? (
                ...
                <p className="text-muted-foreground italic">Biography coming soon.</p>
              )}
            </div>
          </motion.div>
        </div>
  ...
  return (
    <section className="py-16 bg-muted/50 border-t border-border">
      <div className="container">
        ...
        >
          <div>
            <h3 className="text-2xl font-heading font-bold text-foreground">Other Team Members</h3>
            <p className="text-sm text-muted-foreground mt-1">Meet the leadership team of CAGD</p>
          </div>
          <Link
            to="/management/leadership"
