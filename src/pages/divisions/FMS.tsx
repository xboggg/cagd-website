...
const directorates = [
  {
    name: "National Accounts Directorate",
    description:
      "Responsible for facilitation of the usage of the Ghana Integrated Financial Management Information System (GIFMIS) by covered entities, management of standing imprest for covered entities, management of loans and advances granted to GoG staff, and management of 3rd party deposits for payroll deduction codes.",
    sections: [
  ...
  {
    name: "Financial Monitoring Directorate",
    description:
      "Core functions include the monitoring of revenue performance and reporting at covered entities, and monitoring compliance to standards and financial policies of Government by covered entities.",
    sections: [
  ...
  {
    name: "PFMR, Research & Development Directorate",
    description:
      "Explores best practices and provides suggestions and recommendations for enhancing the performance of the CAGD. Seeks to support CAGD's management in the development, implementation and review of laws, standards, accounting manuals, instructions and other technical documentation.",
    sections: [
...
const keyFunctions = [
  {
    ...
    desc: "Production and consolidation of national accounts across central and local government.",
  },
  {
    icon: BarChart3,
    title: "Chart of Accounts",
    desc: "Oversight and management of the Government of Ghana Chart of Accounts.",
  },
  {
    icon: Monitor,
    title: "GIFMIS Facilitation",
    desc: "Facilitating the usage of Ghana's Integrated Financial Management Information System.",
  },
  {
    icon: Eye,
    title: "Financial Monitoring",
    desc: "Monitoring revenue performance and financial reporting compliance across MDAs.",
  },
  {
    icon: Scale,
    title: "Standards Development",
    desc: "Development and review of accounting laws, standards, manuals and instructions.",
  },
  {
    icon: RefreshCw,
    title: "Reform Management",
    desc: "Leading and managing public financial management reform initiatives.",
  },
];
      ...
      >
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-secondary">Services</span> Division
          </motion.h1>
          ...
          >
            Efficient financial management systems for budget implementation,
            accounting and reporting on Public funds.
          </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Reveal delay={0.1}>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                The Financial Management Services (FMS) Division is responsible
                for facilitating the development and implementation of
                efficient/sound Financial Management systems for budget
                implementation, accounting and reporting on Public funds.
              </p>
            </Reveal>
            <Reveal delay={0.15}>
              <p className="text-base text-muted-foreground leading-relaxed mb-8">
                From producing consolidated national accounts to managing the
                Government of Ghana Chart of Accounts, facilitating GIFMIS
                operations, and driving public financial management reforms, the
                FMS Division provides the analytical and policy backbone that
                underpins Ghana's public financial management architecture.
              </p>
            </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                The FMS Division is organized into three directorates, each with
                specialized sections delivering on the Division's mandate.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Three specialized directorates work in concert to deliver sound
                financial management across the public sector.
              </p>
            </div>
          </Reveal>
          ...
          <motion.div style={{ y: quoteY }}>
            <Reveal>
              ...
              <blockquote className="text-xl md:text-2xl lg:text-3xl font-semibold leading-relaxed max-w-3xl mx-auto mb-6">
                Sound financial management systems are the foundation of
        ...
        <div className="container">
          <Reveal>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                The core responsibilities that define the FMS Division's
                contribution to Ghana's public financial management.
              </p>
            </div>
          </Reveal>
