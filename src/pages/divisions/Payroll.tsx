...
const additionalActivities = [
  ...
  "Processing and accounting for payroll deductions to third parties",
  "Recovery of overpayments and unauthorized payments from government employees",
];

const directorates = [
  {
    name: "Active Payroll Processing Directorate",
    description:
      "Processes monthly salaries for all active government employees nationwide. Manages payroll coordination, functional processing, statistics and reporting, third party deduction management, and regional salary disbursement.",
    sections: [
  ...
  {
    name: "Pensions Payroll Processing Directorate",
    description:
      "Manages all pension-related payroll functions including pension computation, processing, and monthly payment disbursement to retired government workers.",
    sections: [
...
const keyFunctions = [
  {
    ...
    desc: "Monthly processing and disbursement of salaries for all active government employees.",
    gradient: "from-rose-600 to-pink-500",
  },
  {
    icon: Banknote,
    title: "Pension Payments",
    desc: "Processing and disbursement of monthly pension payments to retired government workers.",
    gradient: "from-pink-600 to-rose-400",
  },
  {
    icon: Receipt,
    title: "Deduction Management",
    desc: "Processing payroll deductions for taxes, social security, unions, and third party obligations.",
    gradient: "from-red-600 to-orange-500",
  },
  {
    icon: FileCheck,
    title: "Payroll Validation",
    desc: "Generation and transmission of payment vouchers for covered entity validation.",
    gradient: "from-orange-600 to-amber-500",
  },
  {
    icon: BarChart3,
    title: "Statistics & Reporting",
    desc: "Generating payroll statistics, analytics, and management reports.",
    gradient: "from-amber-600 to-yellow-500",
  },
  {
    icon: AlertTriangle,
    title: "Overpayment Recovery",
    desc: "Detection and recovery of overpayments and unauthorized payments.",
      ...
      >
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-white leading-tight max-w-3xl">
            Government Payroll Management Division
          </h1>
          <p className="mt-6 text-lg md:text-xl text-white/80 max-w-2xl leading-relaxed">
            Development, implementation and review of policies and guidelines for processing GoG payroll.
          </p>

          {/* Hero stat badges */}
          <div className="flex flex-wrap gap-3 mt-8">
            {[
              { value: "703+", label: "MDA Spending Units" },
              { value: "2", label: "Directorates" },
              { value: "Monthly", label: "Payroll Cycle" },
            ].map((badge, i) => (
              <motion.div
                key={badge.label}
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  The Government Payroll Management Division is responsible for development, implementation and review of
                  policies and guidelines for processing GoG payroll which includes payment and accounting for salaries and
                  pensions, assignment of deduction codes for third party transactions.
                </p>
                <div className="mt-6 inline-flex items-center gap-2 text-sm bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950/30 dark:to-pink-950/30 border border-rose-200 dark:border-rose-800/40 px-5 py-2.5 rounded-full font-medium text-rose-700 dark:text-rose-300">
                  ...
                  Mr. Baffour Kyei — DCAG, Payroll Management Systems
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 bg-rose-100 dark:bg-rose-950/30 rounded-full px-4 py-2 mb-4">
                ...
                <span className="text-sm font-medium text-rose-700 dark:text-rose-300">Beyond the Core Mandate</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-heading font-extrabold">Additional Activities</h2>
              <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
                In addition to the main function of running the national payroll, other activities include:
              </p>
            </div>
          </Reveal>
        ...
        <div className="container relative z-10 text-center max-w-3xl">
          <Reveal>
            ...
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-heading font-extrabold text-white leading-tight">
              "Every government worker deserves timely, accurate, and transparent compensation."
            </blockquote>
          ...
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
                Core operational functions carried out by the Payroll Management Division.
              </p>
            </div>
          </Reveal>
