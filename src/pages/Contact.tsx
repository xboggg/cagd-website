...
// FAQ items
const QUICK_FAQS = [
  { q: "How do I access my e-Payslip?", a: "Visit epayslip.cagd.gov.gh with your staff ID and registered mobile number." },
  { q: "How do I report a payroll issue?", a: "Contact your regional CAGD office or email payroll@cagd.gov.gh with details." },
  { q: "What are CAGD's working hours?", a: "Monday to Friday, 8:00 AM to 5:00 PM. Closed on weekends and public holidays." },
];
      ...
      <section ref={heroRef} className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="container relative z-10 py-20">
          ...
          >
            ...
            >
              Get in Touch
              <span className="block text-secondary">With Us</span>
            </motion.h1>
                  ...
                  {submitted ? (
                    ...
                    >
                      <div className="grid sm:grid-cols-2 gap-4">
                        <FormField label="Full Name" id="name" value={form.name} onChange={(v) => updateField("name", v)} error={errors.name} maxLength={100} required />
                        <FormField label="Email Address" id="email" type="email" value={form.email} onChange={(v) => updateField("email", v)} error={errors.email} maxLength={255} required />
                      </div>
                      <div className="grid sm:grid-cols-2 gap-4">
                        <FormField label="Phone Number" id="phone" type="tel" value={form.phone} onChange={(v) => updateField("phone", v)} maxLength={20} />
                        <FormField label="Subject" id="subject" value={form.subject} onChange={(v) => updateField("subject", v)} error={errors.subject} maxLength={200} required />
                      </div>
                      <FormField label="Your Message" id="message" value={form.message} onChange={(v) => updateField("message", v)} error={errors.message} maxLength={2000} required rows={4} />
            ...
            <FadeInSection delay={0.2}>
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground">Quick Answers</h2>
                    <p className="text-muted-foreground text-sm">Common questions about CAGD services</p>
                  </div>
                </div>
                ...
                <div className="mt-8 p-6 bg-muted/50 rounded-2xl">
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      { icon: Globe, label: "Website", url: "https://cagd.gov.gh", color: "hover:bg-primary" },
                    ].map((s) => (
                      <motion.a
                        key={s.label}
                        href={s.url}
            ...
            <FadeInSection delay={0.2}>
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground">Regional Offices</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <FadeInSection>
              <div className="bg-card border border-border rounded-2xl p-8 h-full shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-heading font-bold text-foreground mb-4">Head Office</h3>
            ...
            <FadeInSection delay={0.1}>
              <div className="bg-card border border-border rounded-2xl p-8 h-full shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-heading font-bold text-foreground mb-4">Working Hours</h3>
                <div className="space-y-4">
                  {WORKING_HOURS.map((wh) => (
                    <div key={wh.day} className="flex items-center justify-between p-3 rounded-xl bg-muted/50">
                      <span className={cn("font-medium text-sm", wh.active ? "text-foreground" : "text-muted-foreground")}>{wh.day}</span>
                      <span className={cn("text-sm", wh.active ? "text-primary font-semibold" : "text-muted-foreground")}>{wh.hours}</span>
                    </div>
                  ))}
                </div>
                <p className="text-xs text-muted-foreground mt-4 pt-4 border-t border-border">
