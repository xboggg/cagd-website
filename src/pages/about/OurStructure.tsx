...
export default function OurStructure() {
  ...
  return (
    <>
      ...
      {/* ── Hero ── */}
      <ParallaxHero backgroundImage="https://db.techtrendi.com/storage/v1/object/public/cagd-hero-images/hero-image3.png" overlayOpacity={0.6} height="h-[500px] md:h-[600px]">
