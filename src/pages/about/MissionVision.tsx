...
const missionPillars = [
  { icon: Lightbulb, title: "Efficiency", desc: "Leveraging the most appropriate technology and processes to deliver world-class PFM services.", color: "from-amber-500 to-orange-500" },
  { icon: TrendingUp, title: "Skilled Staff", desc: "Developing well-motivated, dedicated professionals committed to excellence in service delivery.", color: "from-primary to-emerald-500" },
  { icon: Globe, title: "Technology-Driven", desc: "Using GIFMIS, e-Payslip, TPRS, and other digital systems to modernize government finance.", color: "from-blue-500 to-cyan-500" },
  { icon: Cpu, title: "Innovation", desc: "Continuously improving systems and processes to meet evolving public financial management needs.", color: "from-purple-500 to-pink-500" },
];
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <Reveal>
              ...
              >
                ...
                <h2 className="font-heading font-extrabold text-3xl mb-6 text-foreground relative">Our Mission</h2>
            ...
            <Reveal delay={0.15}>
              ...
              >
                ...
                <h2 className="font-heading font-extrabold text-3xl mb-6 text-foreground relative">Our Vision</h2>
                <p className="text-muted-foreground leading-[1.9] text-lg relative">
        ...
        <div className="container">
          <Reveal>
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-heading font-extrabold text-foreground">How We Deliver</h2>
              <p className="text-muted-foreground mt-3 max-w-xl mx-auto">Four strategic pillars that enable us to achieve our mission</p>
            </div>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <p className="mt-6 text-white/70 leading-relaxed text-lg">
                Ghana's Controller & Accountant-General's Department has set the standard for transparent, accountable public finance management across the African continent.
              </p>
              <Link
                to="/about/who-we-are"
